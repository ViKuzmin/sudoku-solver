...
func TestScriptCreator_GetScript(t *testing.T) {
	...
	ar := args{
		...
		data1: []string{"760835142253014876814267053137602584648751230502348617486523701071486325325170468"},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := creator.GetScriptString(tt.args.data1); got != tt.want {
